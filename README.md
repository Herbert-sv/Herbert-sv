-  Hi, I’m Herbert Ochoa Junior/intermediate full stack web and Software developer.
-  Back end server .NET core, asp.net
-  C#, working with MVC architecture, generating and Fetching api, CRUD sintax and working with layers classes, signalR, websockets.
-  Front end with Node.js, Express.js, Javascript and React.js for front-end single apps or projects
-  Python FLASK,full REST API, CRUD, AI projects
-  AI projects from AI agents, AI interpreters, audio,chat,text and PBX 
